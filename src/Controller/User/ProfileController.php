...
final class ProfileController extends AbstractController
{
    ...
    #[Route('/mon-compte', name: 'app_front_mon_compte', methods: ['GET'])]
    ...
    public function updateUserAccount(Request $request, EntityManagerInterface $em, SluggerInterface $slugger): Response
    {
        /** @var User $user */
        $user = $this->getUser();
        if (!$user) {
    ...
    public function updateAdminAccount(Request $request, EntityManagerInterface $em, SluggerInterface $slugger): Response
    {
        /** @var User $user */
        $user = $this->getUser();
