...
class BoutiqueController extends AbstractController
{
    ...
    public function detail(int $id, ProduitRepository $repo, ProductRecommendationService $recommendationService): Response
    {
        ...
        $recommended = $recommendationService->getRecommendationsFor($produit);
